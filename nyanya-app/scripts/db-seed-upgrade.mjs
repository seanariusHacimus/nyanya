 ...
 *
 * Устарел с миграции 0012 (2026-09-16): пишет rating_avg константой, а не по
 * опубликованным отзывам, и вставляет отзывы мимо модерации (status по
 * умолчанию — visible). На проде не запускать; локально после запуска средний
 * балл разойдётся с отзывами.
 */
