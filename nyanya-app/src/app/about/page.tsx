...
export const metadata = {
  title: "О сервисе",
  description:
    "nyanya.uz — премиальный сервис подбора домашнего персонала для семьи в Ташкенте: няни, сиделки, помощники по хозяйству и водители.",
};
      ...
      <section className="mx-auto max-w-[1400px] px-5 pt-6 sm:px-8">
        <Reveal>
          <p className="max-w-3xl font-display text-2xl leading-snug font-medium text-ink sm:text-3xl">
            Nyanya.uz — это платформа для поиска нянь, сиделок, помощников по
            хозяйству, водителей и других специалистов. Специалисты
            самостоятельно размещают анкеты на платформе, а модераторы проверяют
            их на соответствие правилам сервиса перед публикацией. Платформа
            помогает пользователям находить специалистов и знакомиться с
            информацией о них, однако окончательное решение о выборе и
            сотрудничестве принимается пользователем самостоятельно.
          </p>
        </Reveal>
      </section>
