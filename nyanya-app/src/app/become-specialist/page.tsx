...
const benefits = [
  ...
  },
  {
    ...
    text: "Семьи открывают ваши контакты и звонят напрямую. Мы не берём процент с вашей работы.",
  },
  {
    icon: Star,
    title: "Отзывы семей",
    text: "Семья, которая открывала ваши контакты, оставляет оценку и отзыв — после проверки модератором их видят следующие.",
  },
];
...
const faq = [
  ...
  },
  {
    ...
    a: "Только зарегистрированные семьи, открывшие ваши контакты. В открытой части анкеты телефона и мессенджеров нет.",
  },
  {
    q: "Можно ли скрыть анкету на время?",
    a: "Да — кнопкой «Приостановить показ» в кабинете. Анкета уходит из каталога, данные и документы остаются на месте, вернуть показ можно в одно нажатие.",
  },
  {
        ...
        <Reveal>
          <div className="rounded-[2px] bg-charcoal px-8 py-14 text-center sm:px-12">
            ...
            <p className="mx-auto mt-4 max-w-xl text-base leading-relaxed text-cream/70">
              Сервис для специалистов и семей сейчас полностью бесплатный. Мы не
              берём процент с вашей работы.
            </p>
          </div>
        </Reveal>
      </section>
