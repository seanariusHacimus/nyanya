...
const faq = [
  ...
  },
  {
    ...
    a: "Анкету и фотографию модератор проверяет до публикации. Паспорт, медицинские справки и дипломы специалист загружает по желанию — когда модератор их примет, анкета получает отметку «Премиум-проверен».",
  },
  {
