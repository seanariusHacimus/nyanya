...
// §6.4 — что мы проверяем. Перечень тот же, что на «Проверке специалистов».
const checks = [
  {
  ...
  },
  {
    ...
    text: "ВИЧ/СПИД — обязательно; ЗППП, туберкулёз и общее состояние здоровья — рекомендуются.",
  },
  {
    icon: GraduationCap,
    title: "Психоневрологический и наркологический диспансеры",
    text: "Специалист не состоит на учёте.",
  },
  {
    icon: EnvelopeSimple,
...
const faq = [
  ...
  },
  {
    ...
    a: "Анкету и фотографию модератор проверяет до публикации — такая анкета отмечена как «Стандартный профиль». Паспорт, медицинские справки и дипломы специалист предоставляет по своему желанию: когда модератор их примет, анкета становится «Премиум-профилем».",
  },
  {
